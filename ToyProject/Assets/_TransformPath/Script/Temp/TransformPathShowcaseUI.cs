    ...
    public sealed class TransformPathShowcaseUI : MonoBehaviour
    {
        ...
        private void Build()
        {
            ...
            CreateText(
                _panelRoot,
                "Keyboard Help",
                "1/2/3 mode · Space pause · R reset · ←/→ seek · Q queue · E event",
        ...
        private void CreateSettingsGroups(Transform parent)
        {
            ...
            CreateButton(_normalSettings.transform, "EVENT", new Vector2(204f, -204f), new Vector2(90f, 32f), new Color(0.5f, 0.3f, 0.16f, 1f), _controller.FireTestEvent);
