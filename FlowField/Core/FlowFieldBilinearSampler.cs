...
namespace Supercent.Common.FlowField
{
    internal static class FlowFieldBilinearSampler
    {
            ...
            out ushort gen3)
        {
            ...
            Vector3 n00 = Vector3.up, n10 = Vector3.up, n01 = Vector3.up, n11 = Vector3.up;
            ...
            normal = FlowFieldVectorUtility.SanitizeSurfaceNormal(normal);
        ...
        private static FlowFieldSample CreateCellSample(
            ...
            int index)
        {
            Vector3 normal = FlowFieldVectorUtility.SanitizeSurfaceNormal(surface.GetSurfaceNormal(index));
            ...
            return new FlowFieldSample(
                direction,
                Mathf.Max(0f, workspace.FinalSpeedMultipliers[index]),
                normal,
                true);
        }
